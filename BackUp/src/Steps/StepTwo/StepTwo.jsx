...
const StepTwo = ({   setRequiredFields, requiredFields, showErrors }) => {
  ...
  const fetchproductFromLocal = async () => {
    const url = `https://cwa-chaturvedi.onrender.com/api/product`;

    try {
      const response = await fetch(url);
      const result = await response.json(); // result.default is your actual data array

      setProduct(result.default); // ✅ Don't stringify
  ...
  // ✅ Filter models based on selected product AND manufacturer
  ...
  // ✅ Filter variants based on selected product, manufacturer, and model
  ...
  // ✅ Filter fuel types based on selected product, manufacturer, model, and variant
    ...
    <div className="capitalize grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select ${showErrors && stepData?.proposalType === "" ? "border-red-500" : "border-[#e6e6e6]"}  px-4 py-2 border-[#e6e6e6] rounded`}
        >
         ...
         {showErrors && stepData?.proposalType === "" && (
      ...
      <div>
        ...
        <select
          ...
          onChange={handleChangeStep}
          className={`w-full border custom-select ${showErrors && stepData?.proposalType === "" || stepData?.policyType === "" ? "border-red-500" : "border-[#e6e6e6]"} px-4 py-2 border-[#e6e6e6] rounded`}
        >
          <option value="">Select</option>
        ...
        {showErrors && stepData?.policyType === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChangeStep}
          className={`w-full border px-4 py-2 ${showErrors && stepData?.receiptNumber === "" ? "border-red-500" : "border-[#e6e6e6]"}  rounded`}
        />
         {showErrors && stepData?.receiptNumber === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      <div>
        ...
        <input
          ...
          className={`w-full border px-4 py-2 ${showErrors && stepData?.receiptNumber === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        />
           {showErrors && stepData?.receiptDate === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      ...
      <div>
        ...
        <select
          ...
          onChange={handleChangeStep}
          className={`w-full border custom-select px-4 py-2 ${showErrors && stepData?.vehicleYear === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        >
...
{showErrors && stepData?.vehicleYear === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      <div>
        ...
        <input
          ...
          onChange={handleChangeStep}
          className={`w-full border px-4 py-2 ${showErrors && stepData?.registrationNumber === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        />
        {showErrors && stepData?.registrationNumber === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChangeStep}
          className={`w-full border px-4 py-2 ${showErrors && stepData?.registrationDate === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        />
         {showErrors && stepData?.registrationDate === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      <div>
        ...
        <input
          ...
          onChange={handleChangeStep}
          className={`w-full border px-4 py-2 ${showErrors && stepData?.chassisNumber === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        />
         {showErrors && stepData?.chassisNumber === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChangeStep}
          className={`w-full border px-4 py-2 ${showErrors && stepData?.engineNumber === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        />
          {showErrors && stepData?.engineNumber === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      <div>
        ...
        <select
          ...
          onChange={handleChangeStep}
          className={`w-full border custom-select px-4 py-2 ${showErrors && stepData?.manufacturingYear === "" ? "border-red-500" : "border-[#e6e6e6]"} rounded`}
        >
          <option value="">Select Year</option>
          {/* You can generate more years dynamically     */}
          <option value="2025">2025</option>
  ...
  {showErrors && stepData?.manufacturingYear === "" && (
              <p className="text-sm text-red-500 mt-1">This field is required.</p>
            )}
      </div>
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select px-4 py-2 border-[#e6e6e6] rounded ${showErrors && stepData?.rtoState === "" ? "border-red-500" : ""}`}
        >
      ...
      <div>
        ...
        <select
          ...
          onChange={handleChangeStep}
          className={`w-full border custom-select px-4 py-2 ${showErrors && stepData?.rtoCity === "" ? "border-red-500" : ""} rounded`}
        >
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select px-4 py-2 border-[#e6e6e6] rounded ${showErrors && stepData?.product === "" ? "border-red-500" : ""}`}
        >
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select px-4 py-2 border-[#e6e6e6] rounded ${showErrors && stepData?.manufacturerType === "" ? "border-red-500" : ""}`}
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select px-4 py-2 border-[#e6e6e6] rounded ${showErrors && stepData?.model === "" ? "border-red-500" : ""}`}
          disabled={!productKey} // disables until product is selected
        >
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border custom-select px-4 py-2  rounded ${showErrors && stepData?.varience === "" ? "border-red-500" : ""}`}
        >
      ...
      <div className="block">
        <label className="block font-medium">Fuel type <span className="text-[#f00]">*</span></label>
         <select
          ...
          onChange={handleChangeStep}
          className={`w-full border custom-select px-4 py-2 border-[#e6e6e6] rounded ${showErrors && stepData?.fueltype === "" ? "border-red-500" : ""}`}
        >
